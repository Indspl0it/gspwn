...
| Never emit a seed referencing an out-of-scope device | A call name the description set does not declare fails the syzkaller-parse gate, and the whole seed bank fails with it |
