...
head:
  - tag: title
    content: gspwn
hero:
  tagline: An autoresearch agent for the NVIDIA GPU kernel driver and the NVIDIA Container Toolkit. It runs successive rounds of coverage-guided fuzzing until the discovery curve plateaus, and reports verified vulnerabilities.
  image:
