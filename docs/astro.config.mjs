      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Container stack fixes', slug: 'knowledgebase/container-stack-fixes' },
          ],
        },
        {
          label: 'Architecture',
          items: [
            ...
            { label: 'Historical targeting', slug: 'architecture/historical-targeting' },
            ...
            { label: 'Extending gspwn', slug: 'architecture/extending' },
            {
              ...
              items: [
                ...
                { label: 'ctrl_rank.py', slug: 'architecture/components/ctrl-rank' },
                { label: 'nvkms_inventory.py', slug: 'architecture/components/nvkms-inventory' },
                { label: 'syzlang_gen.py', slug: 'architecture/components/syzlang-gen' },
                { label: 'surface_verify.py', slug: 'architecture/components/surface-verify' },
                { label: 'surface_cov.py', slug: 'architecture/components/surface-cov' },
                { label: 'verify_tenant_surface.py', slug: 'architecture/components/verify-tenant-surface' },
                { label: 'cve_patch_map.py', slug: 'architecture/components/cve-patch-map' },
                ...
                { label: 'register_check.py', slug: 'architecture/components/register-check' },
          ...
          items: [
            { label: 'Configuration keys', slug: 'reference/configuration' },
            {
              ...
              items: [
                ...
                { label: 'replay_crashes.sh', slug: 'reference/cli/replay-crashes' },
            ...
            {
              label: 'Enumerated surface',
              items: [
                { label: 'Overview', slug: 'reference/surface' },
                { label: 'Escapes', slug: 'reference/surface/escapes' },
